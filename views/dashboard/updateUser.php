            ...
            <div class="col-10 ">
                ...
                <div class="bgDark textGreen mt-5 rounded-3 w-75 mx-auto">
                    ...
                    <form class="d-flex flex-column my-5 w-75 mx-auto pb-3" method="post">
                        ...
                        <input id="pseudo" name="pseudo" class="fieldForm p-2 " type="text" autocomplete="off" value="<?=$user->pseudo?>">
                        <p id="errorPseudo" class="errorMessage"><?=$error['pseudo'] ?? ''?></p>    
                        <label id="labelEmail" class="textGreen mt-4" for="email">E-mail :</label>
                        <input id="email" name="email" class="fieldForm p-2 " type="email" autocomplete="off" value="<?=$user->email?>">
                        ...
                        <input id="password" name="password" class="fieldForm p-2 " type="password" autocomplete="off" value="<?=$user->password?>">
                        <p id="errorPassword" class="errorMessage mb-3"><?=$error['password'] ?? ''?></p>
                        <label for="points">Points</label>
                        <input class="mb-3" type="number" name="points" value="<?=$user->points?>">
