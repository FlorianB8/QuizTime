    ...
    <div class="container-fluid bgBlue">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 formContact">
                ...
                <form class="d-flex flex-column my-5 contact" action="">
                    ...
                    <div class="mx-auto">
                        <input class="btnFormSubmit fieldForm my-3" type="submit" name="confirmContact" id="confirmContact" value="Envoyer">
                    </div>
                </form>
                <!--------------------------->
            </div>
